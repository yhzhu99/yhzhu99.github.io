...
export const profile: Profile = {
  ...
  interests: [
    { uid: "ai-agent-healthcare", title: "AI Agent for Healthcare", description: "Designing autonomous AI co-scientists to support clinical workflows and accelerate healthcare research." },
